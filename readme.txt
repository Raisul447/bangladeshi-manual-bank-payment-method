...
== Installation ==
1. Upload the `bangladeshi-manual-bank-payment-method` folder to the `/wp-content/plugins/` directory.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. Go to WooCommerce -> Settings -> Payments.
4. Locate "Bangladeshi Manual Bank Payment Method" and click 'Manage'.
5. Configure your bank account details and save the changes.
